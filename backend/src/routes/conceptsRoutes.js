...
router.post('/question', requireAuth, llmLimiter, async (req, res) => {
  try {
...
router.post('/answer/mcq', requireAuth, llmLimiter, async (req, res) => {
  try {
...
router.post('/answer/voice', requireAuth, llmLimiter, upload.single('audio'), async (req, res) => {
  try {
